...
/*
 * Robot Builder does not use an XBox joystick model
 * Found a team that solved this problem
 * Below links rae the actual code from Team 318
 * https://raw.githubusercontent.com/Team319/frc319-2018/master/src/org/usfirst/frc/team319/models/BobController.java
 * https://github.com/Team319/frc319-2018/blob/master/src/org/usfirst/frc/team319/robot/OI.java
 */
public class OurXboxController extends Joystick {

	public OurXboxController(int port) {
		super(port);
    ...
    // Couldn't fix the error below
	//public Button leftTriggerButton = new OurXboxLeftTrigger(this);
	//public Button rightTriggerButton = new OurXboxRightTrigger(this);
